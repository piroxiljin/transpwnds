...
///\brief функци€ предназначена дл€ поиска popup родител€
///\param hWnd - хендл окна на родителе, или определенной иерархии дочерних окон или самого popup
///\return хендл popup в случае успеха, если popup оказываетс€ рабочий стол то вернет NULL
...
//////!!!!!!!!!!!!!!это пробное дл€ сквозного клика!!!!


///\class CEnumWindows
///\brief класс дл€ поиска окна под окном, который под курсором мыши
///\note иде€ заключаетс€ в пеереборе окон и проверки всех последующих \n
/// в попадание под курсор.\n
/// ѕри попадании под курсор производитс€ поиск дочернего окна
struct CEnumWindows
{
	HWND m_hwndParent;
	HWND m_hwndNext;
